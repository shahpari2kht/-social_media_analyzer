...
ربات تلگرامی + داشبورد Streamlit برای **جمع‌آوری خودکار داده‌های وب**، ذخیره در CSV و نمایش گرافیکی.  
طراحی شده برای ساده‌سازی فرآیند وب‌اسکرپینگ و مانیتور داده‌ها به‌صورت زنده.
